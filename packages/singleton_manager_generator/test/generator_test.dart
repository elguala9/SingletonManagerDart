  ...
  group('AugmentationGenerator', () {
    group('generate()', () {
      test('should generate DI code for class with single injected field', () {
        ...
        expect(code, contains("MyServiceDI.emptyForDI() : super();"));
        expect(code, contains("factory MyServiceDI.initializeDI() {"));
        expect(code, contains("final instance = MyServiceDI.emptyForDI();"));
      ...
      test('should handle class names with underscores', () {
        ...
        expect(code, contains("final instance = My_Service_ImplDI.emptyForDI();"));
      });
      ...
      test('should generate valid Dart syntax for initializeDI factory method', () {
        ...
        final createMethod = RegExp(
          r'factory MyServiceDI\.initializeDI\(\) \{[^}]*final instance = MyServiceDI\.emptyForDI\(\);[^}]*instance\.initializeDI\(\);[^}]*return instance;[^}]*\}',
          dotAll: true,
        );
