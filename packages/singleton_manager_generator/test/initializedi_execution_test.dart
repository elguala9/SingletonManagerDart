...
void main() {
  group('initializeDI() execution with proper dependency setup', () {
    ...
    test('ServiceConfigGenerated.initializeDI() RUNS quando dipendenze sono registrate', () {
    ...
    test('ServiceC.initializeDI() RUNS quando DatabaseConnection è registrato', () {
      // SETUP: Registra DatabaseConnection
      SingletonManager.instance.register<DatabaseConnection>(DatabaseConnection());
  ...
  group('Full DI pipeline: registerFactory + add<T>()', () {
    ...
    test('add<T>() chiama initializeDI() sulla classe generata e inietta le dipendenze', () {
      SingletonManager.instance.register<String>('prod');
      SingletonManager.instance.register<int>(30);

      SingletonDI.registerFactory<ServiceConfigGenerated>(ServiceConfigGenerated.new);
    ...
    test('SingletonDIAccess.add<T>() (statico) chiama initializeDI() sulla classe generata', () {
      SingletonManager.instance.register<DatabaseConnection>(DatabaseConnection());
    ...
    test('add<T>() con classe generata restituisce singleton (stessa istanza)', () {
    ...
    test('add<T>() lancia StateError se le dipendenze non sono nel registry', () {
      SingletonDI.registerFactory<ServiceConfigGenerated>(ServiceConfigGenerated.new);
  ...
  group('Pattern addInstance: crea istanza + initializeDI() + addInstance', () {
    ...
    test('addInstance registra un\'istanza già inizializzata via initializeDI()', () {
    ...
    test('addInstance con ServiceC mantiene la stessa istanza di DatabaseConnection iniettata', () {
  ...
  group('Pattern addInstanceAs: classe generata registrata tramite interfaccia', () {
    setUp(() {
      SingletonManager.instance.clearRegistry();
    });
    ...
    test('addInstanceAs registra la classe generata sotto l\'interfaccia e la recupera correttamente', () {
      SingletonManager.instance.register<String>('interface-value');

      final instance = ServiceWithInterface();
      instance.initializeDI();
      SingletonDIAccess.addInstanceAs<IGeneratedService, ServiceWithInterface>(instance);
    ...
    test('addInstanceAs sostituisce una registrazione precedente per la stessa interfaccia', () {
      SingletonManager.instance.register<String>('v1');
      final first = ServiceWithInterface();
      first.initializeDI();
      SingletonDIAccess.addInstanceAs<IGeneratedService, ServiceWithInterface>(first);
      ...
      second.initializeDI();
      SingletonDIAccess.addInstanceAs<IGeneratedService, ServiceWithInterface>(second);
  ...
  group('initializeDI() execution WITHOUT dependencies (CRASH)', () {
    ...
    test('ServiceConfigGenerated.initializeDI() CRASHA quando String non è registrato', () {
    ...
    test('ServiceConfigGenerated.initializeDI() CRASHA quando int non è registrato', () {
    ...
    test('ServiceC.initializeDI() CRASHA quando DatabaseConnection non è registrato', () {
