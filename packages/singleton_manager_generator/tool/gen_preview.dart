...
void main() {
  final src = File(
    'test_artifacts/exact_pattern_tests/id_handler_storage_repository_no_ctor_params.dart',
  );
  final parsed = SourceParser.parse([src], verbose: true);
  for (final info in parsed) {
    final outPath =
        'test_artifacts/exact_pattern_tests/id_handler_storage_repository_no_ctor_params_di.dart';
